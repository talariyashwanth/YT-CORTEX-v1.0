...
Gradient Boosting builds trees sequentially, with each new tree fitting the residual errors of the combined ensemble. HistGradientBoosting is an efficient implementation for large datasets.

It often achieves strong performance on tabular data but can overfit if not regularized properly.
